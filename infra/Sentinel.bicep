...
resource ContentHub_Office365 'Microsoft.SecurityInsights/contentPackages@2024-10-01-preview' = {
  name: 'Microsoft 365'
  scope: workspace
  properties: {
    contentId: _solutionId
    contentProductId: '${take(_solutionId,50)}-sl-${uniqueString(_solutionSufix)}'
    contentSchemaVersion: '3.0.4'
    contentKind: 'Solution'
    displayName: 'Microsoft 365 (formerly, Office 365)'
    version: _solutionVersion
  }
  dependsOn: [onboardingStates]
}

// == enable Office365 Data Connector for Exchange data
resource Office365_Connector 'Microsoft.SecurityInsights/dataConnectors@2024-10-01-preview' = {
